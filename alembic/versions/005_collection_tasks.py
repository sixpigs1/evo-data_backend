...
def upgrade():
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('phone', 'task_id', 'target_date', name='uq_collection_assignment_phone_task_date'),
    )
    op.create_index(op.f('ix_collection_assignments_created_by_id'), 'collection_assignments', ['created_by_id'])
    op.create_index(op.f('ix_collection_assignments_phone'), 'collection_assignments', ['phone'])
    ...
    op.create_index('ix_collection_assignments_date_phone', 'collection_assignments', ['target_date', 'phone'])
    ...
    op.create_table(
        ...
        sa.Column('client_info_json', sa.Text(), nullable=True),
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
...
def downgrade():
    ...
    op.drop_index('ix_collection_assignments_date_phone', table_name='collection_assignments')
    ...
    op.drop_index(op.f('ix_collection_assignments_phone'), table_name='collection_assignments')
